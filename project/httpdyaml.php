...
<center>
	...
	<hr />
	<br /><br />
	<form name="k8s" method="post" action="deployhttpd.php">
		...
		스토리지:
		<select name="str">
			<option value="1Gi">1G</option>
                        <option value="2Gi">2G</option>
                        <option value="3Gi">3G</option>
                        <option value="4Gi">4G</option>
			<option value="5Gi">5G</option>
			<option value="6Gi">6G</option>
                        <option value="7Gi">7G</option>
                        <option value="8Gi">8G</option>
                        <option value="9Gi">9G</option>
                        <option value="10Gi">10G</option>
			</select><br /><br /><br />
		호스트:
